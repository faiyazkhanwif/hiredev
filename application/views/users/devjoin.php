            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><button type="button" onclick="window.location='http://localhost/hiredev/'" class="btn btn-light">Home</button></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6">
                        ...
                        <div class="reg-form">
                            ...
                            <br>
                            <div class="text-secondary text-info small"><span class="text-info">* </span><span>By submitting your information, you agree to go through the hiring procedure of HireDev.</span></div>
                            ...
                            <div class="form-group text-center d-grid">
                                <?= form_submit(['name' => 'submit', 'value' => 'Submit', 'class' => 'btn btn-primary btn-lg']); ?>
                            </div>
