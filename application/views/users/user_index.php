            ...
            <div class="container ">
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6">
                        <div class="text-center">
                            <h2 class="fw-bolder animate__animated animate__bounceInLeft">Welcome, <span class="text-info"><?php print $user_details->name ?></span></h2>
                        </div>
                    </div>
                </div>
                <br>
                <div class="row gx-5 animate__animated animate__zoomIn">
                    <div class="col-lg-6 mb-5">
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body p-4 text-center">
                                <img class="rounded mx-auto d-block" width="130" height="130" src="<?= base_url('tool/img/userpic.png'); ?>" alt="..." />
                                <br>
                                <br>
                                <div class="badge bg-primary bg-gradient rounded-pill mb-2">Profile Details</div>
                                <br>
                                <br>
                                <a class="text-decoration-none link-dark stretched-link" href="#!">
                                    <h5 class="card-title mb-3">Name: <span class="text-primary"><?= htmlentities($user_details->name) ?></span></h5>
                                </a>
                                <p class="card-text mb-0"><i class="text-primary fas fa-envelope"></i>&nbsp Email:<span> <?= htmlentities($user_details->email) ?></span></p>
                                <p class="card-text mb-0"><i class="text-primary fas fa-mobile-alt"></i> &nbspPhone:&nbsp<span> <?= htmlentities($user_details->contact) ?></span></p>
                            </div>
                                ...
                                <div class="d-flex align-items-end justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="small">
                                            ...
                                            <div class="text-muted"><i class="fas fa-history"></i> Account created on: <?= htmlentities(date('Y-m-d', strtotime($user_details->createdate))) ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 mb-5">
                        ...
                        <br>
                        <br>
                        <div><a class="btn btn-lg btn-primary" href="<?= base_url('User-home/edit-profile/') ?>">&nbsp&nbsp&nbsp&nbsp&nbspEdit profile&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                        </div>
                        <br>
                        <div><a class="btn btn-lg btn-danger" href="<?= base_url('User-home/change-password/') ?>">Change Password</a>
                        </div>
                    </div>
